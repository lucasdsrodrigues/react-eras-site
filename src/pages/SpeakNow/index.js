  ...
  return (
    <div className="sn-page-container">
      ...
      <div className="sn-forest-root">
        ...
        {/* Silhuetas de árvores puras em CSS clip-path */}
        <div className="sn-tree-sil sn-tree-sil--left"></div>
        <div className="sn-tree-sil sn-tree-sil--right"></div>
        ...
        <div className="sn-main-wrapper">
          <div className="sn-title-area">
            <h1 className="sn-main-title">SPEAK NOW</h1>
