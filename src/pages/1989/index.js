...
const NineteenEightyNine = () => {
    ...
    return (
        <main className={`era-1989-page ${isTV ? 'theme-tv' : 'theme-original'}`}>
            <audio ref={audioRef} />
            ...
            <section className="ninetene-eightynine-hero">
                ...
                <div className="hero-1989-buildings" style={{ backgroundImage: `url('https://www.transparenttextures.com/patterns/stardust.png')` }}></div>

                <div className="hero-1989-main-content">
                    <div className="hero-1989-titles">
                        <h2 className="hero-1989-artist">TAYLOR SWIFT</h2>
                        <h1 className="hero-1989-album-title">1989</h1>
